...
public static void Dollar_to_other(double amt) {
    System.out.println("1 Dollar = " + 82.96 + " Ruppe");
    System.out.println();
    System.out.println(amt+" Dollar = " + (amt*82.96) + " Ruppe");
    System.out.println();
...
public static void Euro_to_other(double amt){
    System.out.println("1 Euro = " + 90.72 + " Ruppe");
    System.out.println();
    System.out.println(amt+" Euro = " + (amt*90.72) + " Ruppe");
    System.out.println();
